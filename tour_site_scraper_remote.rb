...
# DISPLAY=:1 xvfb-run java -jar selenium-server-standalone-3.14.0.jar
WEB_DRIVER = Selenium::WebDriver.for(:remote, :url => 'http://localhost:4444/wd/hub', :desired_capabilities => :firefox)
